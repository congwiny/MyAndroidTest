...
public final class EmojiPopup {
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            Log.e(TAG, "height difference=" + heightDifference+
                    ",getUsableScreenHeight="+getUsableScreenHeight()+
            ...
            if (resourceId > 0) {
                ...
                Log.e(TAG, "dimension size=" + resources.getDimensionPixelSize(resourceId));
            }
            ...
            if (heightDifference > MIN_KEYBOARD_HEIGHT) {
                ...
                Log.e(TAG, "keyboard Height" + keyBoardHeight);
